...
public class CacheConstant {
	...
	/** 客户发送消息后如果10分钟内未读，则向老师推送 某一订单第一条推送记录 保留 7天**/
	public static final String ORDER_CHAT_MASTER_UNREAD_LAST_PUSH = "ORDER_CHAT_MASTER_UNREAD_LAST_PUSH";
	///** 老师某次回复后，如果半小时内该用户没有再访问该订单，将会收到“老师回复了”保留 7天  **/
