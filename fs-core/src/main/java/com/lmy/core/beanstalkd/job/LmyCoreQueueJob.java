...
public class LmyCoreQueueJob extends AbstractStartJob {
	public static void main(String[] args) throws Exception {
		...
		AdminQueueManagerServiceImpl adminQueueManagerServiceImpl = (AdminQueueManagerServiceImpl)SpringContextUtil.getBean(res,"adminQueueManagerServiceImpl");
		...
		startJob.setHandler(1800 +6, orderQueueManagerServiceImpl);
		startJob.setHandler(1800 +8, adminQueueManagerServiceImpl);
		startJob.begin(args);
	}
}
